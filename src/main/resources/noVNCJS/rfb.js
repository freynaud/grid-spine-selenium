...
if (Websock_native) {
    cdef('connectTimeout',    'int', 10,    'Time (s) to wait for connection');
} else {
    cdef('connectTimeout',    'int', 20,    'Time (s) to wait for connection');
}
cdef('disconnectTimeout', 'int', 20,    'Time (s) to wait for disconnection');
cdef('check_rate',        'int', 1000,  'Timing (ms) of send/receive check');
cdef('fbu_req_rate',      'int', 2000, 'Timing (ms) of frameBufferUpdate requests');
